        ...
        private async void tabControl1_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (tabControl1.SelectedTab.Name.Equals("updatePage"))
            {
                ...
                try
                {
                    ...
                    // https://api.rss2json.com/v1/api.json?rss_url=https://github.com/SN-Koarashi/LiliumLauncher/releases.atom
                    JObject obj = await launcher.getUpdateNotes("https://api.rss2json.com/v1/api.json?rss_url=https://github.com/SN-Koarashi/LiliumLauncher/releases.atom");
