...
namespace Global
{
    class gb
    {
        ...
        public static async void checkForUpdate(bool isForce)
        {
            ...
            try
            {
                ...
                if (compareResult > 0)
                {
                    ...
                    {
                        var p = new Process();
                        p.StartInfo.FileName = UpdaterPath + Path.DirectorySeparatorChar + "LiliumLauncher.exe";  // just for example, you can use yours.
        ...
        private static void cleanTempFiles()
        {
            ...
            string tempFileInstaller = UpdaterPath + Path.DirectorySeparatorChar + "LiliumLauncher-installer-temp.exe";
